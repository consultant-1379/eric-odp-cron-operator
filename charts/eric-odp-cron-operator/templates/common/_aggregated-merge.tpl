...
{{- define "eric-odp-cron-operator.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-odp-cron-operator.mergeAnnotations" -}}
  {{- include "eric-odp-cron-operator.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-odp-cron-operator.mergeLabels" -}}
  {{- include "eric-odp-cron-operator.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
